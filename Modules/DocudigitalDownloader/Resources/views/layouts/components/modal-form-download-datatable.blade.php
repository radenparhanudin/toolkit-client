<div class="modal fade" id="modalFormDownloadDatatable">
    <div class="modal-dialog {{ (isset($modal['size'])) ? $modal['size'] : ""}}">
        <div class="modal-content">
            <form id="formDownloadModalDatatable" action="{{ $form['action'] }}" method="POST">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" class="btn btn-sm btn-primary"><i class="fas fa-cloud-download-alt fa-fw fa-fw mr-2"></i>Download</button>
                </div>
            </form>
        </div>
    </div>
