...
<head>
    ...
    <title>Docudigital Uploader</title>
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="{{ route('docudigital-uploader.home.index') }}" class="nav-link text-dark"><i class="fas fa-laptop-house fa-fw mr-1"></i>Home</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('docudigital-uploader.group-dokumen.index') }}" class="nav-link text-dark"><i class="fas fa-layer-group fa-fw mr-1"></i>Group Dokumen</a>
                        </li>
                    </ul>
                </div>
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="https://blog-toolkit.lombokdev.web.id/category/docudigital-uploader/" target="_blank" class="nav-link text-dark"><i class="fas fa-blind fa-fw"></i>Cari Petunjuk</a>
                    </li>
                </ul>
            </div>
        </nav>
