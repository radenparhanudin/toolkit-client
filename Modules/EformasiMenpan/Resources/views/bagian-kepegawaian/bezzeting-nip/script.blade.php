<script>
    $(document).ready(function(){
        var dataTableDefault = $('#dataTableDefault').DataTable({
            searching: false,
            ajax: {
                url: "{{ route('efm.bk.bezzeting-nip.data') }}",
                data: function (d) {
            ...
            columns: [
                ...
                {data: 'nama_jabatan', className: 'align-middle'},
                {data: 'nip_hidden', className: 'w-5 text-nowrap align-middle'},
                {data: 'nama', className: 'w-5 text-nowrap align-middle'},
                {data: 'detail', className: 'align-middle d-none'},
                {data: 'action', className: 'text-center w-5 align-middle d-none'},
            ]
        })
