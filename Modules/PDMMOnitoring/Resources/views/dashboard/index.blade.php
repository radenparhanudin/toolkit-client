...
<div class="content-header">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <h4 class="m-0 text-secondary float-right"><small>Module PDM Monitoring</small></h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-4">
                <div class="card card-primary card-outline py-2">
                    <div class="card-body box-profile">
                        ...
                        <p class="text-center">
                            <a href="{{ route('pdm-monitoring.autentikasi.logout') }}" class="btn btn-sm btn-dark"><i class="fas fa-sign-out-alt fa-fw mr-1"></i>Logout</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body py-5 text-center">
                        <p class="lead" style="font-weight: normal">
                            Terima kasih sudah menggunakan Module ToolKit <br><strong>PDM Monitoring</strong>
                        </p>
                        <p class="pt-4">
