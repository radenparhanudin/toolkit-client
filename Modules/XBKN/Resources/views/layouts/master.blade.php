        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="{{ route('x-bkn.dashboard.index') }}" class="nav-link text-dark"><i class="fas fa-tachometer-alt fa-fw mr-1"></i>Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('x-bkn.data-asn.index') }}" class="nav-link text-dark"><i class="fas fa-user-graduate fa-fw mr-1"></i>Data ASN</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('x-bkn.data-usul.index') }}" class="nav-link text-dark"><i class="fas fa-layer-group fa-fw mr-1"></i>Data Usul</a>
                        </li>
                    </ul>
                </div>
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="https://blog-toolkit.lombokdev.web.id/category/x-bkn/" target="_blank" class="nav-link text-dark"><i class="fas fa-blind fa-fw"></i>Cari Petunjuk</a>
                    </li>
                </ul>
            </div>
        </nav>
